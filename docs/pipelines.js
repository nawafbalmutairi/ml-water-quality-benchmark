...
export const pipelines = {
  ...
  'water-quality': {
  "accent": "teal",
  "title": "From monitoring records to a controlled benchmark",
  "stages": [
    {
      "n": "01",
      "k": "Collect",
      "name": "Environment Agency records",
      "d": "Monitoring records from 2000–2025 across 14 Environment Agency areas in England, organised by area and year.",
      "stat": "26 years",
      "note": "14 areas · England"
    },
    {
      "n": "02",
      "k": "Organise",
      "name": "Manual rename & review",
      "d": "I renamed the downloaded files manually and spotted my own naming mistake: the Thames 2000 and 2001 files were swapped. I corrected them before constructing the final dataset.",
      "stat": "2000 / 2001",
      "note": "Thames filenames corrected manually"
    },
    {
      "n": "03",
      "k": "Clean",
      "name": "Handle censored measurements",
      "d": "Retain the five selected parameters. Treat readings marked < or > as missing, because detection limits are not exact measurements.",
      "stat": "5 parameters",
      "note": "avoid false numerical precision"
    },
    {
      "n": "04",
      "k": "Reshape",
      "name": "Long to wide",
      "d": "Reshape individual measurements into columns for each sampling point and date. Each target uses its own valid subset, so sample counts differ between targets.",
      "stat": "long → wide",
      "note": "one modelling table per target"
    },
    {
      "n": "05",
      "k": "Engineer",
      "name": "Water measurements + calendar features",
      "d": "Predict one parameter using the other four selected water-quality measurements plus year, month and day extracted from the observation date.",
      "stat": "4 + 3 inputs",
      "note": "water parameters + calendar features"
    },
    {
      "n": "06",
      "k": "Split",
      "name": "Evaluate on later observations",
      "d": "Train on 2000–2017 and test on 2018–2025. Approximately 6.7 million training and 1.6 million testing samples across the five target datasets, not multiplied by four models.",
      "stat": "6.7M / 1.6M",
      "note": "train / test · approximate target totals"
    },
    {
      "n": "07",
      "k": "Benchmark",
      "name": "Four models × five targets",
      "d": "Benchmark Ridge, Random Forest, MLP and XGBoost within the IBM SPSS Modeler workflow. Python, Pandas and NumPy support preparation; scikit-learn and XGBoost support modelling and evaluation.",
      "stat": "20 combinations",
      "note": "shared split and inputs within each target"
    },
    {
      "n": "08",
      "k": "Evaluate",
      "name": "Metrics, plots and Power BI",
      "d": "Compare R², RMSE and MAE for every combination. Present the results in the report and an interactive Power BI dashboard. XGBoost leads on R² for four targets; Ridge leads on BOD, although all BOD R² scores are negative.",
      "stat": "R² 0.785",
      "note": "best result · XGBoost × water temperature"
    }
  ]
},
